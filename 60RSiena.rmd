...
We have our empirically estimated model (`ans`). We set initial effects values of our simulation models based on our empirically estimated model (`ans`) and we fix the effects at these values. We specify 2 additional models:
...
#macro-/network-outcome of interest: skewness of the degree distribution (measured through gini)
